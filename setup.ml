(* OASIS_START *)
(* DO NOT EDIT (digest: d299c6827e97b461fc5bcf48374e30e6) *)
(*
...
let setup_t =
  {
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources =
                        ["blit_stubs_xen.c"; "float_stubs_xen.c"];
                      bs_data_files = [];
                      bs_ccopt =
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\208|\164\219\157\133\020\234!\161\007N\002&\127\240";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
